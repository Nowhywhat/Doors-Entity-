...
local entity = Spawner.createEntity({
    CustomName = "Rush",
    Model = "rbxassetid://11564808949", -- Your entity's model url here ("rbxassetid://1234567890" or GitHub raw url)
    Speed = 90,
    MoveDelay = 3,
    HeightOffset = 0,
    CanKill = true,
